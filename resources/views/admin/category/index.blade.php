@extends('admin.layouts.app', ['title' => 'Список категории техник', 'active_clients' => 'active'])
                                ...
                                <table class="table">
                                    ...
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('technicCategories.edit', $category->id)}}" class="waves-effect btn btn-primary"><i class="material-icons">edit</i></a>
                                                <form action="{{route('technicCategories.destroy', $category->id)}}" method="POST" style="display:inline-block">
                                                    @method('delete')
                                                    @csrf
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('technicCategories.store')}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
