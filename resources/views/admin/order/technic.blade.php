@extends('admin.layouts.app', ['title' => 'Список заказов техник', 'active_clients' => 'active'])
                                ...
                                <table class="table">
                                    ...
                                    @foreach($orders as $order)
                                        <tr>
                                            ...
                                            <td>{{$order->technic['charac_value']}}</td>
                                            <td>
                                                @switch($order->status)
                                                    @case(0)
                                                    Не зачат
                                            ...
                                            <td>
                                                <form action="{{route('technicOrders.destroy', $order->id)}}" method="POST" style="display:inline-block">
                                                    @method('delete')
                                                    @csrf
