@extends('admin.layouts.app', ['title' => 'Список типов характеристик', 'active_clients' => 'active'])
                                ...
                                <table class="table">
                                    ...
                                    @foreach($types as $type)
                                        <tr>
                                            ...
                                            <td>{{$type->title}}</td>
                                            <td>
                                                <a href="{{route('characterTypes.edit', $type->id)}}" class="waves-effect btn btn-primary"><i class="material-icons">edit</i></a>
                                                <form action="{{route('characterTypes.destroy', $type->id)}}" method="POST" style="display:inline-block">
                                                    @method('delete')
                                                    @csrf
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('characterTypes.store')}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
